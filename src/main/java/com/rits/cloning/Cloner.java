...
public class Cloner {
    ...
    protected <T> T cloneInternal(T o, Map<Object, Object> clones) {
        ...
        if (clz.getName().contains("$Lambda")) {
            return o;
        }

//        AutoPilotHandler.HandleResult result = AutoPilotHandler.handleClone(this, o, clones);
//        if (result.cloneType == AutoPilotHandler.CloneType.REPLACE_OBJECT) {
//            return (T) result.replacementObject;
//        }
